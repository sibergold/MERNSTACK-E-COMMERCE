    ...
    <div className='rounded-lg border p-4 shadow-sm border-gray-700 bg-gray-800 md:p-6'>
       ...
       <img className='h-20 md:h-32 rounded object-cover' src={item.image}/>
         ...
         <div className='flex items-center justify-between md:order-3 md:justify-end'>
           ...
           <button className='inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-600 bg-gray-700 hover:bg-gray-600 focus:outline-none 
           focus:ring-2 focus:ring-emerald-500 '  onClick={()=>updateQuantity(item._id, item.quantity - 1)}>
